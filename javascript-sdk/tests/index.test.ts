...
describe("sign", () => {
  ...
  const method = "POST";
  const apiKey: UUID = "ef05e5b0-9daf-49e3-a0f4-9a3c13f55c3b";
  const apiSecret: UUID = "4ae4bf20-0afa-4122-ade8-c0beca7bd5e4";
  const timestamp = new Date(1798115622000);
  const nonce: UUID = "4428a206-1afd-4b15-a98d-43e91f49a08d";
